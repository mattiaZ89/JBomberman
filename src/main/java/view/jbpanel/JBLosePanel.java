...
/**
 * Rappresenta la schermata di sconfitta
 */
@SuppressWarnings("serial")
public class JBLosePanel extends JPanel {
	...
	private Color background = new Color(220, 20, 60);
	...
	public void paintComponent(Graphics g) {
		...
		g2d.setFont(g2d.getFont().deriveFont(attributes));
		g2d.drawString("SORRY", 310, 230);
		g2d.drawString("YOU LOSE", 260, 350);
